...
public class ComentarEventoVacioInteraction implements Interaction {
    ...
    public <T extends Actor> void performAs(T t) {
        ...
        t.attemptsTo(Enter.theValue("").into(COMENTAR));
        t.attemptsTo(Click.on(SUBMIT));
    }

    public static ComentarEventoVacioInteraction comentarEventoVacio() {
        return Tasks.instrumented(ComentarEventoVacioInteraction.class);
    }
